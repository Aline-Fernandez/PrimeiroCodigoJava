...
## 🚀 O que foi praticado
- [x] **Configuração de Ambiente:** Instalação do JDK e configuração da IDE.
- [x] **Sintaxe Básica:** Estrutura de uma classe Java e declaração do método `public static void main`.
- [x] **Saída de Dados:** Uso do `System.out.println` para exibição de informações.
- [x] **Compilação e Execução:** Processo de transformar o código fonte em bytecode e executá-lo.
...
## 💻 Exemplo de Código
O projeto foca na estrutura fundamental:
```java
public class Main {
